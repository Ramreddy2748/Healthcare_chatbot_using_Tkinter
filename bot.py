...
# =====================================================  LOAD MODELS ==================================================
dtc , le  = pk.load(open('/Users/ramreddy/HealthCare_ChatBot/chatbot_modelsave','rb'))
model,second_le  = pk.load(open('/Users/ramreddy/HealthCare_ChatBot/chatbot_model','rb'))
#ners = pk.load(open('/home/durgesh-dev/Desktop/Final Year Projects/chatbot/HealthCare_ChatBot/newsave_model','rb'))

# Load NN Model 
FILE = "/Users/ramreddy/HealthCare_ChatBot/data.pth"
